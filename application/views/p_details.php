...
<div id="main_container">
  <div id="main_content"> 
	...
	<div>
	  <?php
session_start();
//echo $this->session->userdata("year")."   ".$this->session->userdata("category");;
 echo form_open('Student_proposals/supervisors') ?>
 <br />
      <fieldset style=" border-color:#617798; border-style:solid; border-radius:6px">
      <legend style="color:#617798; font-weight:bold">STEP 2 : Project Details</legend>
      <pre >    
   ...
   <input type="date" name="date"/>
      ...
      <p class="submit">
	  <br />
        <input name="submit" type="submit" value="Save and Continue to STEP 3" />
      </p>
