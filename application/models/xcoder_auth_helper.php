...
class xcoder_auth_helper extends CI_Model{
   ...
   function validation()
   {
       $this->form_validation->set_rules('name','Name','required|max_length[30]|required');
       $this->form_validation->set_rules('reg_no','Registration Number','required|max_length[11]|required');
       $this->form_validation->set_rules('course','Course','required|max_length[30]|required');
       $this->form_validation->set_rules('intrests','Intrests','required|required');
