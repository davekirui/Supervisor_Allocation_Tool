...
<div id="main_container">
  <div id="main_content"> 
	...
	<!-- end of main content -->
	<!-- InstanceBeginEditable name="EditRegion2" --><!-- InstanceEndEditable --><!-- InstanceBeginEditable name="EditRegion1" -->
<div>
<br />
	  <div align="center">
        <?php
session_start();
include "connect.php";
$sql=mysql_query("SELECT * FROM supervisors ORDER BY sur_name asc");
echo form_open('Supervisors/login') ?>
        <fieldset style=" border-color:#617798; border-style:solid; border-radius:6px; width:350px">
        <legend style="color:#617798; font-weight:bold">Level Control</legend>
          <pre>
    <span>Identity:</span>     
    <select name="sur_name">
   <?php while($row1=mysql_fetch_array($sql)){ ?>
   <option><?php echo $row1['sur_name']?></option>
   <?php }?>   
   </select>
   <span>Passcode:</span>
