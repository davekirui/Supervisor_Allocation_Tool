...
<div id="body">
        ...
        ?>
                ...
                Intrests             :<input type="text" name="intrests" />
		...
		confirm password     :<input type="password" name="confirm_password" />
                  ...
                  <xcdr><?php echo form_error('email');	?> <?php echo form_error('user');	?> <?php echo form_error('password');	?> <?php echo form_error('confirm_password');	?></xcdr>
