...
<div>
  <?php
	...
	?>
  <?php echo form_open('Allocatio_report/report') ?>
  <fieldset style=" border-color:#617798; border-style:solid; border-radius:6px">
  <legend style="color:#617798; font-weight:bold">Start Processing Allocation </legend>
  <pre>    
  ...
  <p class="submit">
    <input name="submit" type="submit" value="Command Process" />
  </p>
