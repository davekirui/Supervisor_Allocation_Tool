...
<div>
	...
	{
	echo "Supervisor : ".$this->session->userdata('sur_name')?>
...
<?php
	...
	?>
<?php echo form_open('Supervisors/accept') ?>
<br />
<fieldset style=" border-color:#617798; border-style:solid; border-radius:6px">
<legend style="color:#617798; font-weight:bold">Accept Student's Application</legend>
<pre> 
    <span>Project:</span> 
    ...
    <input type="text" name="reg_no" required="required"/>
    </pre>
</fieldset>
<br />
<p class="submit">
  <input type="submit" value="Save" name="btn" />
  <input type="submit" value="Accept another Student" name="btn" />
</p>
